...
CREATE TABLE `victimas` (
  ...
  `Sexo` text NOT NULL,
  `Orientacionsexual` varchar(30) NOT NULL,
...
INSERT INTO `victimas` (`Tipodocumento`, `Numerodocumento`, `Nombres`, `Apellidos`, `Sexo`, `Orientacionsexual`, `Direccion`, `Telefono`) VALUES
